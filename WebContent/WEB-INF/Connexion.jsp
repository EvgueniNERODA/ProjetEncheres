...
<body>
	...
	<form action="<%=request.getContextPath() %>/ServletConnexion"
		...
		<div>
			<label for="indentifiant">Identifiant:</label> <input type="text"
		...
		<div>
			<input type="checkbox" name="SeSouvenirDeMoi"> <label
	...
	<div>
		<a href="${pageContext.request.contextPath }/ServletInscription"><button>Créer
				un compte</button></a>
	</div>
